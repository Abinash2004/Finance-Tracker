...
class _MemberListState extends State<MemberList> {
  final databaseRef =
      FirebaseDatabase.instance.ref('User').child(MemberList.user);
  String std = '1';
  bool isClass = true;
                  ...
                  items: [
                    for (int i = 1; i <= 12; i++)
                      DropdownMenuItem<String>(
                          ...
                          child: Text('Class $i',
                              style: textStyle(
                                  Colors.white, 20, FontWeight.w500, 1, 0.25))),
                  ],
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return Center(
                  child: Text(
                    'No Data Available',
                    style:
                        textStyle(Colors.white70, 20, FontWeight.w500, 1, 0.25),
                  ),
                );
              } else {
                // Process the data
                    ...
                    return isClass
                        ? Card(
                            ...
                            child: ListTile(
                              ...
                              subtitle: memberListSubTitle(
                                  '+91 ${list[index]['Phone Number']}'),
                              onTap: () async {
                                ...
                                (MemberList.user != 'Admin')
                                    ? AccountScreen.joiningDate =
                                        list[index]['Joining Date']
                                    : null;
                                (MemberList.user == 'Student')
                                    ? AccountScreen.std = list[index]['Class']
                                    : null;
                                Navigator.push(
                                    context,
                                    MaterialPageRoute(
